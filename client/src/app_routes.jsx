...
import HomeAppliencesServices from './components/services/HomeAppliancesServices';
...
import ServiveProviderDashboard from './components/serviceProvider/ServiceProviderDashboard';
...
import ServiveProviderDashboardLayout from './ui/ServiceProviderDashboardLayout';
...
const app_routes = [
  // Authentication Routes
  {
    path: '/auth',
    element: <Auth />,
    children: [{ path: '/auth/login', exact: true, element: <LoginPage /> }],
  },

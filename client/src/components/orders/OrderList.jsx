...
const orders = [
  {
    id: 1,
    name: 'Mohsin Javed',
    location: 'Punjab University Employees Society House Number XYZ Block C',
    contact: '03091948615',
    timing: '1:00 pm - 3:00 pm',
    pricePerHour: 'Rs 300',
    items: 'Fan Installing, Washing Machine Repair',
    status: 'Pending',
  },
  {
    id: 2,
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="text-[6px] sm:text-[8px] md:text-[10px] lg:text-[12px] xl:text-[14px] font-medium">
                ...
                <h2 className="text-gray-600">Location: {order.location}</h2>
                <h2 className="text-gray-600">Contact: {order.contact}</h2>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <div className="text-[6px] sm:text-[8px] md:text-[10px] lg:text-[12px] xl:text-[14px]">
                <h2 className="">Timing: {order.timing}</h2>
                <h2 className="">Price Per Hour: {order.pricePerHour}</h2>
                <h2 className="">Items: {order.items}</h2>
              </div>
              <div className="flex flex-col gap-2">
                <button className="bg-[#FF4141] text-[white] p-1 sm:p-2 text-[8px] sm:text-[12px] md:text-[14px] lg:text-[16px] rounded-xl">
                  Status:{order.status}
                </button>
                <button className="bg-[#FF4141] text-[white] p-1 sm:p-2 text-[8px] sm:text-[12px] md:text-[14px] lg:text-[16px] rounded-xl">
                  Cancel Order

...
import MixerTapPic from "../images/MixerTapPic.jpg";
  ...
  return (
    <>
      <div className="w-full min-h-screen bg-white mx-auto">
        ...
        <div className="w-full max-w-[1665px] h-[85px] bg-white flex items-center justify-between flex-shrink-0">
          {/* Close Button */}
        ...
        {/* Services Section */}
        <div className="w-full flex flex-col items-center justify-center mt-10 mb-20  space-y-8">
          <div className="max-w-screen-xl h-auto bg-[#EDEDED] rounded-[20px] shadow-lg p-6 sm:p-8">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
              ...
              {/*Search Bar*/}
              <div className="w-full sm:w-[334px] h-[50px] sm:h-[71px] flex-shrink-0 bg-[#FFF] rounded-[32px] mr-16">
                <input
                  type="text"
                  placeholder="Search"
          ...
          {/*Continue Button*/}
          <div className="w-full max-w-screen-xl flex justify-end pr-4 sm:pr-8">
            <div className="flex items-center justify-between w-[250px] sm:w-[334px] h-[65px] bg-[#4184F1] rounded-[4px] p-4">
              ...
              <div className="flex items-center">
                <span className="text-[#FFF] font-[Wix Madefor Display] text-[19px] font-semibold leading-[34px]">
                  continue
                </span>
                <svg
                  ...
                  className="ml-2"
                >
                  <path d="M14.5469 0.292786L14.897 0.105469L14.897 0.105469C15.1336 -0.0129271 15.4183 0.0112318 15.6283 0.138601L15.6283 0.138601L25.7527 5.66708L25.7527 5.66708C25.9386 5.78011 26.0413 5.98982 26.0413 6.2082C26.0413 6.42657 25.9386 6.63628 25.7527 6.74931L25.7527 6.74931L15.6283 12.2778L15.6283 12.2778C15.4183 12.4052 15.1336 12.4294 14.897 12.3109L14.897 12.3109L14.5469 12.1236L14.5469 12.1236C14.2175 11.9601 14.0625 11.5535 14.1875 11.2115L14.1875 11.2115L16.4827 4.54831L16.4827 4.54831L14.1875 7.61149C14.0625 7.26949 14.2175 6.86288 14.5469 6.69939L14.5469 6.69939L25.7527 5.66708L25.7527 5.66708L14.5469 4.63478Z" />
                </svg>
              </div>
            </div>
          </div>
